  ...
  constructor(gui,titleGui) {
    ...
    ( object ) => {
      ...
      object.traverse((child) => {
        if (child.isMesh) {
          child.material = new THREE.MeshStandardMaterial({color: 0xD29BFD});
        }
      });
      caballo.add ( object ) ;
    } , null , null ) ;
    ...
    var materialArena = new THREE.MeshPhysicalMaterial({color: 0xf5deb3, roughness:0.7, reflectivity:0.2, normalMap: normalMap});
    ...
    var soporteMesh = new THREE.Mesh(soporte, materialArena);
